      ...
      <Container>
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          <StaggerReveal className="max-w-2xl">
            ...
            <StaggerItem>
              <p className="text-base md:text-lg text-[var(--color-muted-foreground)] leading-relaxed mb-8 max-w-[600px]">
            ...
            <StaggerItem>
              <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center mb-10">
                <Link href="/register" className="w-full sm:w-auto">
                  <Button
                    size="lg"
                    className="w-full text-lg shadow-md hover:shadow-xl hover:-translate-y-1 transition-all duration-300 relative group overflow-hidden"
                  >
