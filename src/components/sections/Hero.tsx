...
export function Hero() {
  return (
    <Section className="min-h-screen pt-32 pb-24 lg:pt-40 lg:pb-32 flex flex-col justify-center overflow-hidden">
      <Container>
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          <StaggerReveal className="max-w-2xl">
            ...
            <StaggerItem>
              <h1 className="h1 text-[var(--color-foreground)] leading-[1.1] mb-6">
            ...
            <StaggerItem>
              <p className="body-regular text-[var(--color-muted-foreground)] mb-8 max-w-[600px]">
                Discover the psychology behind communication that makes people
                remember your brand, trust your message, and choose you over
                everyone else.
              </p>
            </StaggerItem>
            ...
            <StaggerItem>
              <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center mb-10">
                <Link href="/register" className="w-full sm:w-auto">
                  <Button
                    size="lg"
                    className="w-full text-lg shadow-md hover:shadow-xl hover:-translate-y-1 transition-all duration-300 relative group overflow-hidden flex items-center justify-center gap-2"
                  >
          ...
          <FadeIn
            direction="left"
            delay={0.3}
            className="relative hidden lg:block h-[600px] w-full rounded-[32px] bg-gradient-to-br from-[var(--color-muted)] to-[var(--color-background)] border shadow-premium overflow-hidden"
          >
            <motion.div
              animate={{ y: [0, -15, 0] }}
